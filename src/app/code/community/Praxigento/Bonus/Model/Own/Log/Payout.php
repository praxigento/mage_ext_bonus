 ...
 *
 */
class Praxigento_Bonus_Model_Own_Log_Payout extends Mage_Core_Model_Abstract
{
    ...
    {
        $this->_init(Config::CFG_MODEL . '/' . Config::ENTITY_LOG_PAYOUT);
    }
